...
pub(crate) fn creat_crowdfund_event(
    e: &Env,
    id: u64,
    recipient: Address,
    deadline: u64,
...
pub(crate) fn creat_crowdfund_event_v2(e: &Env, crowdfund_args_list: Vec<CrowdfundArgs>) {
    let topics = (Symbol::new(e, "creat_crowdfund_event"),);
    e.events().publish(topics, crowdfund_args_list);
}
